...
<div class="row align-items-center mt-5">
    <div class="col-md-8 col-11 mx-auto">
        <form class="needs-validation" novalidate method="post" action="{{ route('appointment.walk-in.create') }}">
            ...
            <div class="card shadow mb-5">
                ...
                <div class="card-body">
                    ...
                    <div class="alert " role="alert">
                        <h4><b>REMINDER:</b></h4> Registration at Parañaque City Hall is strictly limited to employees
                        of the City Government of Parañaque. Parañaque Citizens belonging to the PWD or Senior Citizen
                        sector should select OSPAR 1 as their registration site. Those not included in these groups are
                        advised to wait for further announcements regarding HELP Card registration.
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <select name="transaction_type_id" id="transaction_type_id"
                                    data-old="{{ old('transaction_type_id') }}" class="form-control">

                                    @foreach ($transactiontype as $tp)
                                    <option {{ old('transaction_type_id') == $tp->id ? 'selected' : '' }}
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="input-group">
                                    {{--
										<input class="form-control text-uppercase {{ !empty(old('departmentid')) && old('departmentid')  != 2 ? 'd-none' : '' }}"
                                    type="text" placeholder="BIN" id="bin" min="0" step="1"
                                    name="bin" onkeypress='return event.charCode >= 48 && event.charCode <= 57'
                                        minlength="1" maxlength="10" value="{{ old('bin') }}">
                                        ...
                                        <div class="input-group-append">
                                            <button class="btn btn-secondary" type="button" id="bin-biz-name">
                                                ...
                                                <div class="spinner-border spinner-border-sm text-white d-none"
                                                    id="biz_info_find" role="status" style="margin-left: 5px;">
                                                    <span class="sr-only">Loading...</span>
                                                </div>
                                            </button>
                                        </div>
                        ...
                        {{-- 
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <input class="form-control text-uppercase {{ !empty(old('departmentid')) && old('departmentid')  != 2 ? 'd-none' : '' }}"
                        type="text" placeholder="BUSINESS NAME" id="business_name"
            ...
            <h6 class="card-title text-center bg-info text-white p-1"><i class="fas fa-user-friends mr-2"></i> PERSONAL
                INFORMATION</h6>
            <div class="form-group">
                <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <input class="form-control" type="number" placeholder="" id="cno" min="0" step="1" name="cno"
                            onkeypress='return event.charCode >= 48 && event.charCode <= 57' value="{{ old('cno') }}">
            ...
            <h6 class="card-title text-center bg-info text-white p-1"><i class="fas fa-map-marked-alt mr-2"></i>ADDRESS
            </h6>
            <div class="form-group">
                <div class="row">
                    <div class="col-md-3">
                        <label class="labelhld" for="houseno">HOUSE NO</label>
                        <input class="form-control text-uppercase" type="text" id="houseno" name="houseno">
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input class="form-control text-uppercase" type="text" placeholder="" id="lotno" name="lotno">
                    </div>
                    <div class="col-md-3">
                        <label class="labelhld" for="unitno">UNIT NO</label>
                        <input class="form-control text-uppercase" type="text" placeholder="" id="unitno" name="unitno">
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <input class="form-control text-uppercase" type="text" placeholder="" id="addr1" name="addr1">
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="row">
                    <div class="col-md-12">
                        <label class="labelhld" for="addr2">STREET / AVENUE / ROAD / EXTENSION / BOULEVARD /
                            CORNER</label>
                        <input class="form-control text-uppercase" type="text" placeholder="" id="addr2" name="addr2">
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <input class="form-control text-uppercase" type="text" placeholder="" id="addr3" name="addr3">
                    </div>
            ...
            <h6 class="card-title text-center bg-info text-white p-1">
                ...
                <span class="spinner-border spinner-border-sm ml-2 d-none" id="appoint-spiner" role="status"
                ...
                <div class="col-md-6 mb-3">
                    <div class="form-inline d-flex justify-content-md-center">
                        ...
                        <div class="div-sm-100">
                            <input class="form-control" type="text" id="walk_in_adate" name="adate"
                ...
                <div class="col-md-6">
                    <div class="form-inline d-flex justify-content-md-center">
                        ...
                        <select class="form-control" name="atime" id="walk_in_atime" required>
                            ...
                            $startTime = $currentDateTime->format('Y-m-d') . ' ' .
                            \Carbon\Carbon::createFromFormat('g:i A', trim($startTime))->format('H:i:s');


                            $configGracePeriod =
                            (int)\App\Helpers\SettingHelper::get(\App\Models\Setting::KEYS['walk_in_grace_period']);
                            ...
                            $i++;
                            @endphp
                            <option {{ old('atime') == $time->timeslot ? 'selected' : '' }}
                                {{  $disableTimeslot ? 'disabled' : '' }} value="{{ $time->timeslot }}">
