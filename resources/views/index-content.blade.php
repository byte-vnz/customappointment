    ...
    <div class="col-md-8 col-11 mx-auto">
        <form class="needs-validation" id="master-form" novalidate>
            <div class="card shadow mb-5">
                <h5 class="card-header text-muted"><i class="fas fa-globe-asia"></i> {{ config('app.name', 'Appointment') }}</h5>
                <div class="card-body">
	
				    <h6 class="card-title text-center bg-info text-white p-1"><i class="fas fa-address-book"></i> ADVISORY</h6>
                
				<div class="alert " id="alert" role="alert">
                    At the end of the registration process, a QR code will be generated. Please take a screenshot of this QR code, as it will serve as your proof of appointment when you arrive on your scheduled date and time.
                </div>
                            ...
                            <div class="alert alert-info department-alert department-alert-active d-none" data-alert-id="24">
                                <p class="mb-0"> 
                                     @foreach ($transtype as $tp)
                                        <h4><b>REMINDER:</b></h4> This appointment registration is strictly for PWDs, Solo Parents, and Senior Citizens of Barangay {{ $tp->name }}. Those who are not part of these groups are advised to wait for further announcements regarding the HELP Card registration.
                                    @endforeach
...
--}}
                    ...
                    <h6 class="card-title text-center bg-info text-white p-1"><i class="fas fa-info mr-2"></i>OTHER INFORMATION</h6>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-inline d-flex justify-content-md-center">
                                ...
                                <div class="div-sm-100">
                                    ...
                                    <input class="form-control" type="date" id="adate" name="adate" min="{{ $min_dt }}" >
                            ...
                            <div class="form-inline d-flex justify-content-md-center">
                                ...
                                <select class="form-control" name="atime" id="atime" required>
                                    @foreach ($time_intervals as $time)
                                      <option value="{{ $time->timeslot }}">{{ trim(explode('-', $time->timeslot)[0]) }}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                <button type="submit" id="btn-submit-appointment" class="btn btn-success float-right btn-block shadow-sm">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12 text-md-center">
                                <a href="{{ url('/cancellation') }}" class="active btn btn-outline-success" role="button" aria-pressed="true">
				...
				<div class="modal-body">
					<div class="row-md-12">
						<div class="col-md-12 text-center">
							This is your onsite appointment schedule. Kindly secure the <strong>Reference Number</strong> or <strong>QR Code</strong> and present this upon entry Thank you.
						</div>
					</div>
					...
					<div class="row">	
                        ...
                        <div class="col-12 text-center mt-5">
                            ...
                            <strong>REFERENCE NUMBER </strong>  <h3 class="aptrefno text-success"></h3>
                        </div>						      
                    </div>

                        <div class="row mt-1">			
							<div class="col-md-12 text-center ">
								<strong>LOCATION </strong> <h5 class="apttrans"></h5>
							</div>
						</div>
					
						<div class="row mt-1">			
							<div class="col-md-12 text-center ">
								<strong>DATE </strong> <h5 class="aptadate"></h5>
							</div>
						</div>
						
						<div class="row mt-1">
							<div class="col-md-12 text-center">
								<strong>TIME </strong>  <h5 class="aptatime"></h5>
							</div>
						</div>
